...
function TPCommandGroup({
  ...
  return (
    <CommandGroup
      className={cn(
        "[&_[cmdk-group-heading]]:text-[12px] [&_[cmdk-group-heading]]:font-semibold [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider [&_[cmdk-group-heading]]:text-tp-slate-400",
        className,
      )}
      {...props}
    />
...
function TPCommandItem({
  ...
  return (
    <CommandItem
      className={cn(
        "rounded-lg px-3 py-2 text-[14px] font-medium text-tp-slate-700 data-[selected=true]:bg-tp-blue-50 data-[selected=true]:text-tp-blue-700",
        className,
      )}
      {...props}
    />
