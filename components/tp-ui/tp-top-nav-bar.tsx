 ...
 *   Toolbar icon  42px, bg-[#f1f1f5], rounded-[10px]
...
function ToolbarIconButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "relative flex shrink-0 items-center justify-center bg-[#f1f1f5] rounded-[10px]",
        extraClass,
      )}
      ...
      >
        <div className="flex items-center gap-[16px] pr-[16px] py-[10px] size-full">
          ...
          <div className="flex items-center gap-[14px] shrink-0">
            ...
            <button
              type="button"
              className="flex shrink-0 items-center justify-center gap-[6.3px] bg-[#f1f1f5] rounded-[10px]"
            ...
            <button
              type="button"
              className="relative flex shrink-0 items-center justify-center gap-[6.3px] rounded-[10px]"
              style={{
                height: 42,
                padding: "8px 16px",
            ...
            <button
              type="button"
              className="flex shrink-0 items-center justify-center gap-[6.3px] bg-[#4b4ad5] rounded-[10px]"
              style={{ height: 42, padding: "8px 16px" }}
            >
    ...
    >
      <div className="flex items-center gap-[16px] px-[18px] py-[10px] size-full">
        ...
        <div className="flex items-center gap-[14px] shrink-0">
          ...
          {/* Ask Tatva AI button */}
          <div
            className="relative shrink-0 overflow-hidden rounded-[12px] bg-white"
