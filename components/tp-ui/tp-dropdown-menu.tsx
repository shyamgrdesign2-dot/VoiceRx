...
function TPDropdownMenuItem({
  ...
  return (
    <DropdownMenuItem
      className={cn(
        "rounded-lg px-3 py-2 text-[14px] font-medium text-tp-slate-700 focus:bg-tp-blue-50 focus:text-tp-blue-700",
        className,
      )}
      {...props}
    />
...
function TPDropdownMenuLabel({
  ...
  return (
    <DropdownMenuLabel
      className={cn(
        "px-3 py-1.5 text-[12px] font-semibold uppercase tracking-wider text-tp-slate-400",
        className,
      )}
      {...props}
    />
...
function TPDropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      className={cn(
        "rounded-lg px-3 py-2 text-[14px] font-medium text-tp-slate-700 focus:bg-tp-blue-50",
        className,
      )}
      {...props}
    />
