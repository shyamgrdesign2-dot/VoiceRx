...
const typographyTokensList = [
  ...
  { token: "TP.text.overline", element: "span", family: "Inter", size: "12px", weight: "700", lineHeight: "14px", tracking: "0.08em", usage: "Section overlines, category labels", cssVar: "--tp-text-overline" },
]
