      ...
      <div className="flex flex-col gap-1 px-1">
        ...
        {cssVar && (
          <button
            ...
            className="inline-flex items-center gap-1 self-start rounded bg-tp-slate-100 px-1.5 py-0.5 font-mono text-[10px] text-tp-slate-500 hover:bg-tp-slate-200 hover:text-tp-slate-700 border border-tp-slate-200 transition-colors cursor-pointer"
          >
            {cssVar}
        ...
        {twClass && (
          <button
            ...
            className="inline-flex items-center gap-1 self-start rounded bg-purple-50 px-1.5 py-0.5 font-mono text-[10px] text-purple-500 hover:bg-purple-100 hover:text-purple-700 border border-purple-100 transition-colors cursor-pointer"
          >
            text-{twClass}
