        ...
        <div className="flex-1 min-w-[240px]">
          ...
          <div className="flex flex-col gap-3 text-xs text-tp-slate-600">
            ...
            <div className="mt-2 p-3 rounded-lg bg-tp-slate-50 border border-tp-slate-100">
              <p className="text-[12px] text-tp-slate-500 font-semibold mb-1.5">Spacing & Dimensions</p>
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[12px] text-tp-slate-500">
