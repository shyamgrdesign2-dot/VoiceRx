                  ...
                  >
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-md bg-tp-blue-50 px-2 py-0.5 font-mono text-[12px] font-semibold text-tp-blue-700 hover:bg-tp-blue-100 border border-tp-blue-100 transition-colors"
                      >
                        {tokenName}
                        {copied === tokenName ? (
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-md bg-tp-slate-100 px-2 py-0.5 font-mono text-[12px] text-tp-slate-600 hover:bg-tp-slate-200 border border-tp-slate-200 transition-colors"
                      >
                        {cssVar}
                        {copied === cssVar ? (
                          <CheckCircle2 size={9} className="text-green-500" />
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-md bg-purple-50 px-2 py-0.5 font-mono text-[12px] text-purple-600 hover:bg-purple-100 border border-purple-100 transition-colors"
                      >
                        {twClass}
                      </button>
                    </td>
