...
function IconTile({
  ...
  return (
    <div className={`rounded-xl border bg-white p-3 ${state === "active" ? "border-tp-blue-200" : "border-tp-slate-200"}`}>
      ...
      <p className="truncate text-[12px] font-medium text-tp-slate-700">{name}</p>
            ...
            <div key={ctx.title} className="rounded-lg border border-tp-slate-200 bg-tp-slate-50/40 p-3">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-[12px] font-mono text-tp-slate-500">{ctx.token}</p>
                </div>
              </div>
              <p className="mt-2 text-[12px] text-tp-slate-600">{ctx.note}</p>
            </div>
          ))}
        </div>
      </div>
