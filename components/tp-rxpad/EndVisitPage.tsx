        ...
        <div className="mx-auto flex h-full w-full items-center justify-between">
          <div className="inline-flex h-full items-center">
            <button
              ...
              className="relative flex h-[62px] w-[80px] shrink-0 items-center justify-center bg-white px-[15px] py-[20px] transition-colors hover:bg-tp-slate-50"
            >
              <div
                aria-hidden
          ...
          <div className="inline-flex items-center gap-[14px]">
            ...
            <button
              ...
              className={cn(
                "inline-flex h-[42px] min-w-[100px] items-center justify-center rounded-[10.5px]",
