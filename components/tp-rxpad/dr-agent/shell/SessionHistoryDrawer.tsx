    ...
    <TPDrawer open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-2 bg-white px-4 py-3">
          ...
          <h2 className="flex-1 truncate text-[15px] font-semibold text-tp-slate-900">
        ...
        <div className="flex shrink-0 items-center gap-2 bg-white px-4 py-2.5">
          ...
          <div className="flex min-w-0 flex-col">
            <span className="truncate text-[13px] font-semibold text-tp-slate-800">{patientName}</span>
            <span className="truncate text-[11px] text-tp-slate-500">{patientMeta}</span>
          </div>
        </div>
        <div className="h-px shrink-0 bg-tp-slate-100" />
                      ...
                      >
                        ...
                        <div className="flex min-w-0 flex-1 flex-col gap-1 py-[1px]">
                          <div className="flex items-center justify-between gap-2">
                            <span className="truncate text-[13.5px] font-semibold text-tp-slate-900">
                              {s.dateLabel}
                            </span>
                            <span className="shrink-0 text-[11px] font-medium text-tp-slate-500">
                              {s.time}
                            </span>
                          </div>
                          <span
                      ...
                      <ul className="flex flex-col gap-2">
                        {active.transcript.map((line, i) => (
                          <li
                            key={i}
                            className={cn(
                              "max-w-[88%] rounded-2xl px-3 py-2 text-[13px] leading-[1.45]",
                              line.speaker === "doctor"
                          ...
                          >
                            <span className="block text-[10.5px] font-semibold uppercase tracking-wider opacity-70">
                              {line.speaker}
                            </span>
                            <span>{line.text}</span>
                          </li>
                      ...
                      <div className="flex flex-col gap-3">
                        {active.tpmr.map((section) => (
                          <div key={section.title} className="rounded-xl border border-tp-slate-100 bg-white p-3">
                            <div className="text-[11px] font-semibold uppercase tracking-wider text-tp-slate-500">
                              {section.title}
                            </div>
                            <ul className="mt-1 flex flex-col gap-1 pl-4 text-[13px] text-tp-slate-700 [&>li]:list-disc">
