      ...
      >
          ...
          <span className="vrx-agent-brand-tag relative flex items-center gap-[7px] rounded-[10px] p-[5px]">
            ...
            <TPDropdownMenu>
              <TPDropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="vrx-agent-brand-kebab inline-flex h-[22px] w-[22px] items-center justify-center rounded-[7px] text-tp-slate-500 transition-colors hover:bg-white/70 hover:text-tp-slate-800 active:scale-[0.94]"
                  aria-label="Dr. Agent options"
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onClose}
            className="vrx-agent-collapse-tag pointer-events-auto relative z-10 flex h-[32px] w-[32px] items-center justify-center rounded-[10px] text-tp-slate-600 transition-colors hover:text-tp-slate-900 active:scale-[0.95]"
