      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-[12px] overflow-y-auto px-[16px] pb-[20px] pt-[14px]">
          <textarea
            ...
            rows={4}
            className="w-full resize-none rounded-[8px] border border-tp-slate-200 bg-white px-[12px] py-[10px] text-[13px] leading-[1.5] text-tp-slate-800 outline-none transition-colors placeholder:text-tp-slate-300 focus:border-tp-blue-400 focus:ring-2 focus:ring-[rgba(75,74,213,0.08)]"
          />
          <button
            type="button"
