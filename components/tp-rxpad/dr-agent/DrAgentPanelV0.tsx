        ...
        <div className="relative z-[1] mt-[16px] grid grid-cols-2 gap-[10px] w-full">
          {actions.map((action, i) => (
            ...
            >
              ...
              <span className="relative z-[1] text-[12px] font-semibold leading-[16px] w-full" style={{ color: "#3D3D4E" }}>
                {action.title}
              </span>
              <span className="relative z-[1] mt-[4px] text-[12px] font-normal leading-[16px] w-full v0-card-subtitle" style={{ color: "#9E9EA8" }}>
                {action.subtitle}
              </span>
            </button>
          ))}
    ...
    <div className="relative z-[1] flex flex-col w-full px-[16px] mt-[16px] pb-[20px]">
      ...
      <div className="v0-search-wrapper relative">
        ...
        <input
          ...
          className="v0-search-input w-full rounded-[8px] border border-tp-slate-200 bg-white py-[8px] pl-[32px] pr-[10px] text-[14px] text-tp-slate-700 placeholder:text-tp-slate-300 outline-none transition-all"
      ...
      <div className="mt-[8px] w-full max-h-[280px] overflow-y-auto rounded-[10px] border border-tp-slate-100 bg-white v0-patient-list" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
        {!query.trim() && (
          <div className="px-[12px] py-[6px] border-b border-tp-slate-300">
            <p className="text-[12px] font-medium text-tp-slate-400 tracking-wide">Today&apos;s appointments</p>
          </div>
        )}
        {query.trim() && filtered.length === 0 ? (
          <p className="py-[16px] text-center text-[14px] text-tp-slate-400">No patients found</p>
        ) : (
          filtered.map((p) => {
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[14px] font-semibold text-tp-slate-800">{p.label}</p>
                  <p className="text-[12px] text-tp-slate-400 leading-[1.3]">
    ...
    return (
      <div className={cn(
        ...
        >
          ...
          <span style={{ color: "#3D3D4E", fontWeight: 600, fontSize: 12, lineHeight: "12px" }}>{selected.label}</span>
          {metaContent}
        </span>
      </div>
    )
          ...
          {animatingPatient && (
            <div className="relative z-[2] flex items-center justify-center pt-3 pb-1">
              ...
              >
                ...
                <span style={{ color: "#3D3D4E", fontWeight: 600, fontSize: 12 }}>{animatingPatient}</span>
              </span>
            </div>
          )}
