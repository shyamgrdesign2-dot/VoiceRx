        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {count !== undefined && count > 0 && (
              <span className="inline-flex items-center justify-center rounded-full bg-tp-blue-50 px-2 py-0.5 text-[11px] font-semibold text-tp-blue-600">
                {count}
              </span>
            )}
          </div>
          {subtitle && (
            <p className="truncate text-[11px] text-tp-slate-400">{subtitle}</p>
          )}
        </div>
