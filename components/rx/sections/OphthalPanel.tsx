  ...
  return (
    <details open className="group/oph mb-3 last:mb-0">
      ...
      <div className="rounded-b-lg border border-t-0 border-tp-slate-200 bg-white p-3 space-y-3">
        {/* Vision Table */}
        <div>
          <span className="text-[11px] font-semibold uppercase tracking-wider text-tp-slate-500 mb-1.5 block">Vision</span>
        ...
        {entry.iop && (
          <div>
            <span className="text-[11px] font-semibold uppercase tracking-wider text-tp-slate-500 mb-1.5 block">Intraocular Pressure</span>
        ...
        {entry.anteriorSegment && (
          <div>
            <span className="text-[11px] font-semibold uppercase tracking-wider text-tp-slate-500 mb-1 block">Anterior Segment</span>
        ...
        {entry.posteriorSegment && (
          <div>
            <span className="text-[11px] font-semibold uppercase tracking-wider text-tp-slate-500 mb-1 block">Posterior Segment</span>
            <div className="grid grid-cols-2 gap-2 text-xs">
