  ...
  return (
    <div className={`group/item flex items-start gap-2.5 rounded-lg border px-3 py-2 mb-2 last:mb-0 ${rule.style}`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-0.5 text-[11px] opacity-80">{allergy.reaction}</p>
    ...
    <div className="group/item flex items-start gap-2.5 rounded-lg border border-tp-slate-200 bg-white px-3 py-2 mb-2 last:mb-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        {condition.medications && condition.medications.length > 0 && (
          <p className="text-[11px] text-tp-slate-500 mt-0.5">Rx: {condition.medications.join(", ")}</p>
        )}
        {condition.notes && (
          <p className="text-[11px] italic text-tp-slate-400 mt-0.5">{condition.notes}</p>
        )}
      </div>
      <CopyButton onCopy={onCopy} size={12} />
    </div>
  ...
  return (
    <div className="group/item flex items-start gap-2.5 rounded-lg border border-tp-slate-200 bg-white px-3 py-2 mb-2 last:mb-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        {surgery.outcome && (
          <p className="text-[11px] text-tp-slate-400 mt-0.5">{surgery.outcome}</p>
        )}
      </div>
      <CopyButton onCopy={onCopy} size={12} />
    </div>
  ...
  return (
    <div className="group/item flex items-start gap-2.5 rounded-lg border border-tp-slate-200 bg-white px-3 py-2 mb-2 last:mb-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        {entry.ageOfOnset && (
          <p className="text-[11px] text-tp-slate-500 mt-0.5">Onset: {entry.ageOfOnset}</p>
        )}
        {entry.notes && (
          <p className="text-[11px] italic text-tp-slate-400 mt-0.5">{entry.notes}</p>
        )}
      </div>
      <CopyButton onCopy={onCopy} size={12} />
    </div>
    ...
    <div className="space-y-1">
      ...
      >
        {history.allergies.length === 0 ? (
          <p className="py-2 text-[11px] text-tp-success-600">No known allergies (NKA)</p>
        ) : (
