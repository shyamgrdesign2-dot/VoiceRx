      ...
      <div className="mb-3 flex items-start justify-between gap-2">
        <div className="min-w-0">
          <div className="mb-1 flex items-center gap-2">
            <span className="inline-flex size-7 items-center justify-center rounded-[10px]" style={{ background: AI_GRADIENT_SOFT }}>
            ...
            <div className="inline-flex min-w-max items-center gap-1.5">
              {promptSuggestions.map((prompt) => (
                <button
                  ...
                  className="whitespace-nowrap rounded-full border border-tp-violet-200 px-2.5 py-1 text-[12px] font-semibold"
                  style={{
                    background:
