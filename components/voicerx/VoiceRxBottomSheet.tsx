      ...
      >
        ...
        <div className="flex items-start justify-between border-b border-tp-slate-100 px-[16px] pb-[12px] pt-[8px]">
          <div className="min-w-0">
            <h3 className="inline-flex items-center gap-1.5 text-[17px] font-semibold leading-tight text-tp-slate-900">
              ...
              <Tooltip>
                ...
                <TooltipContent
                  side="top"
                  sideOffset={8}
                  className="max-w-[300px] rounded-[8px] border-0 bg-tp-slate-900 px-[12px] py-[10px] text-[12.5px] leading-[1.5] text-white shadow-[0_12px_28px_-12px_rgba(15,23,42,0.55)]"
                >
