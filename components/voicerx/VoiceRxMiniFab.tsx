          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 48,
                borderRadius: 999,
                background: manualMute ? "#2B1D3A" : "#fff4e6",
                boxShadow: manualMute
                  ? "inset 0 1px 0 rgba(255,255,255,0.12), 0 8px 18px rgba(22,8,32,0.3)"
            ...
            >
              ...
              <span style={{ display: "inline-flex", transform: "rotate(-90deg)", transformOrigin: "center" }}>
                <VoiceMicIcon size={30} color="#F59E0B" muted={manualMute} />
              </span>
            </button>
