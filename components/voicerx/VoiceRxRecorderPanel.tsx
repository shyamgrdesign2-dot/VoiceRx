...
const MENU_ITEM_TP =
  "cursor-pointer rounded-md text-[13px] text-tp-slate-700 outline-none hover:bg-tp-slate-100 hover:text-tp-slate-900 focus:bg-tp-slate-100 focus:text-tp-slate-900 data-[highlighted]:bg-tp-slate-100 data-[highlighted]:text-tp-slate-900"
      ...
      <div className="relative z-10 flex justify-center pb-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="center" className="max-w-[280px] border-tp-slate-200 bg-white p-1 shadow-md">
            <DropdownMenuLabel className="px-2 py-1.5 text-[11px] font-semibold text-tp-slate-500">
              Select Microphone
            </DropdownMenuLabel>
