...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .section-subtitle { font-size: 14px; font-weight: 600; color: #515158; margin-bottom: 12px; text-transform: uppercase; letter-spacing: 0.5px; }
    .section-desc { font-size: 14px; color: #717179; margin-bottom: 16px; }
    ...
    .type-label { font-size: 12px; font-weight: 600; color: #4B4AD5; font-family: ui-monospace, 'SF Mono', Menlo, Consolas, monospace; }
    ...
    .component-desc { font-size: 14px; color: #717179; margin-bottom: 20px; }
    ...
    .tp-btn-sm { height: 32px; padding: 0 10px; font-size: 14px; }
    .tp-btn-md { height: 38px; padding: 0 14px; }
    .tp-btn-lg { height: 44px; padding: 0 18px; font-size: 16px; }
    ...
    .tp-label { font-size: 14px; font-weight: 600; color: #3A3A42; }
    ...
    .tp-input-focus { border: 2px solid #4B4AD5; box-shadow: 0 0 0 3px rgba(75,74,213,0.08); padding: 0 12px; }
    .tp-input-filled { border-color: #A2A2A8; background: #F8F8FC; }
    .tp-input-error { border: 2px solid #E11D48; box-shadow: 0 0 0 3px rgba(225,29,72,0.08); padding: 0 12px; }
    .tp-input-error .tp-input-icon { color: #E11D48; }
    .tp-input-success { border: 2px solid #10B981; box-shadow: 0 0 0 3px rgba(16,185,129,0.08); padding: 0 12px; }
    ...
    .tp-alert-content p { font-size: 14px; opacity: 0.85; }
    ...
    .progress-label { font-size: 12px; font-weight: 600; color: #717179; margin-bottom: 4px; display: block; }
    ...
    .tp-badge-pill { display: inline-flex; padding: 3px 10px; font-size: 12px; font-weight: 600; border-radius: 9999px; }
